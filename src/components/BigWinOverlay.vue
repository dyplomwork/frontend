...
<style scoped>
/* Global BIG WIN overlay (epic, but reusable across games) */
.bigwin{
  position: fixed;
  inset: 0;
  z-index: 9999;
...
.bigwin-sparks{ position:absolute; inset:0; pointer-events:none; opacity: .92; mix-blend-mode: screen; }
.bigwin-sparks i{
  position:absolute;
  left: 50%;
  top: 55%;
...
@keyframes bigwinBackdrop{ 0%{ opacity: 0; } 10%{ opacity: 1; } 100%{ opacity: 0; } }
@keyframes bigwinRays{ 0%{ transform: scale(.7) rotate(-18deg); opacity: 0; } 15%{ opacity: .9; } 100%{ transform: scale(1.15) rotate(12deg); opacity: 0; } }
@keyframes bigwinBurst{ 0%{ transform: scale(.55); opacity: 0; filter: blur(12px); } 18%{ opacity: 1; } 100%{ transform: scale(1.18); opacity: 0; filter: blur(2px); } }
@keyframes bigwinShock{ 0%{ transform: scale(.55); opacity: 0; } 30%{ opacity: 1; } 100%{ transform: scale(1.20); opacity: 0; } }
...
@keyframes bigwinShine{ 0%{ opacity: 0; transform: translateX(-35%) rotate(18deg); } 20%{ opacity: 1; } 100%{ opacity: 0; transform: translateX(35%) rotate(18deg); } }
@keyframes bigwinTitle{ 0%{ transform: scale(.86); opacity: 0; letter-spacing: .22em; } 100%{ transform: scale(1); opacity: 1; letter-spacing: .10em; } }
...
@keyframes bigwinAmount{ 0%{ transform: translateY(10px) scale(.90); opacity: 0; } 26%{ transform: translateY(0) scale(1.02); opacity: 1; } 100%{ transform: translateY(0) scale(1); opacity: 1; } }
@keyframes sparkFly{
  0%{ opacity: 0; transform: translate(-50%,-50%) scale(.7); }
  20%{ opacity: 1; }
  100%{ opacity: 0; transform: translate(-50%,-50%) rotate(var(--a, 0deg)) translateX(var(--d, 260px)) scale(.18); }
}
@keyframes bigwinShake{ 0%{} 10%{ transform: translateY(0) scale(1.03) translateX(0); } 15%{ transform: translateY(0) scale(1.03) translateX(3px); } 20%{ transform: translateY(0) scale(1.03) translateX(-3px); } 25%{ transform: translateY(0) scale(1.03) translateX(2px); } 30%{ transform: translateY(0) scale(1.03) translateX(-2px); } 100%{} }
